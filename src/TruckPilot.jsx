          ...
          return(
            <div key={m.id||i} style={{display:"flex", justifyContent:isMine?"flex-end":"flex-start", alignItems:"flex-end", gap:8, marginBottom:4}}>
              ...
              <div style={{maxWidth:"72%"}}>
                ...
                {m.text&&(
                  <div style={{background:isMine?"linear-gradient(135deg,#1E88E5,#00BCD4)":"linear-gradient(135deg,#FF6A00,#FF8C00)", color:"#fff", borderRadius:isMine?"18px 18px 4px 18px":"18px 18px 18px 4px", padding:"10px 14px", fontSize:13, lineHeight:1.5, boxShadow:"0 1px 4px rgba(0,0,0,0.12)"}}>
                    {m.text}
                  </div>
                )}
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"linear-gradient(160deg,#0A1628,#0D47A1)", zIndex:99999, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:32 }}>
      ...
      <button onClick={() => { if (isLast) onDone(); else setStep(s => s+1); }}
        style={{ background:"linear-gradient(135deg,#00BCD4,#1E88E5)", border:"none", borderRadius:50, color:"#fff", fontFamily:"'Barlow Condensed',sans-serif", fontWeight:800, fontSize:16, padding:"16px 48px", cursor:"pointer", boxShadow:"0 4px 24px rgba(0,188,212,0.5)" }}>
        {current.cta} →
      </button>
              ...
              <div className="slt-dropdown-footer" style={{ flexDirection:"column", gap:8 }}>
                ...
                <button onClick={() => { openUpgrade(); setOpen(false); }}
                  style={{ width:"100%", padding:"9px", border:"none", borderRadius:9, cursor:"pointer", fontFamily:"'Barlow Condensed',sans-serif", fontWeight:800, fontSize:12,
                    background: plan==="pro" ? "linear-gradient(135deg,#FFD600,#FF6D00)" : plan==="basic" ? "linear-gradient(135deg,#1E88E5,#0D47A1)" : "linear-gradient(135deg,#FF6A00,#FF8C00)",
                    color:"#fff" }}>
            ...
            <div style={{position:"absolute",top:"110%",right:0,zIndex:9999,background:"#fff",borderRadius:16,boxShadow:"0 8px 32px rgba(0,0,0,0.18)",padding:"20px 22px",minWidth:240,border:`2px solid ${C.border}`}}>
              <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:16,paddingBottom:14,borderBottom:`1px solid ${C.border}`}}>
                ...
                <div>
                  ...
                  <div style={{display:"inline-block",background:session.role==="superadmin"?"#EDE7F6":isOwner?"#E3F2FD":"#E0F2F1",color:session.role==="superadmin"?"#FF6A00":isOwner?C.blue:C.teal,borderRadius:20,padding:"2px 10px",fontSize:11,fontWeight:800,marginTop:3}}>{session.role==="superadmin"?"👑 Super Admin":isOwner?"⭐ Owner":"🚛 Driver"}</div>
                </div>
              </div>
      ...
      <div className="slt-hero" style={{paddingBottom:24}}>
        ...
        <div style={{marginTop:4}}>
          <button onClick={()=>setTab("new")}
            ...
            style={{background:"linear-gradient(135deg,#00BCD4,#1E88E5)",border:"none",borderRadius:50,color:"#fff",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:900,fontSize:16,padding:"14px 36px",cursor:"pointer"}}>
            ...
            <div key={plan.id} onClick={() => setSelected(plan.id)}
              ...
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:8 }}>
                <div>
                  ...
                  <span style={{ fontFamily:"'Barlow Condensed',sans-serif", fontWeight:800, fontSize:16, color:"#0A1628" }}>{plan.label}</span>
                </div>
                <div style={{ textAlign:"right" }}>
                  {plan.price === 0
  ...
  return (
    <div className="slt-page">
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:"60vh", padding:24, textAlign:"center" }}>
        ...
        <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:22, fontWeight:800, color:"#0A1628", marginBottom:8 }}>
